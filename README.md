...
- Spring Security for authentication and authorization (environment-configured credentials)
...
- Configure credentials with `NOMAD_ADMIN_USER` and `NOMAD_ADMIN_PASSWORD`
...
app.allowed-origins=${NOMAD_ALLOWED_ORIGINS:http://localhost:8080}
